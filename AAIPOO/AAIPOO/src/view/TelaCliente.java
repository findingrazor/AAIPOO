...
public class TelaCliente extends TelaBase implements MetodosObrigatorios{
	...
	private void initialize() {
		...
		lblTitulo.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 32));
		lblTitulo.setBounds(171, 36, 339, 40);
		frame.getContentPane().add(lblTitulo);

		JLabel lblNome = new JLabel("Nome");
		lblNome.setForeground(new Color(0, 0, 0));
		lblNome.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 20));
		lblNome.setBounds(27, 143, 62, 31);
		frame.getContentPane().add(lblNome);

		JLabel lblCPF = new JLabel("CPF");
		lblCPF.setForeground(new Color(0, 0, 0));
		lblCPF.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 20));
		lblCPF.setBounds(27, 229, 41, 31);
		frame.getContentPane().add(lblCPF);

		JLabel lblEmail = new JLabel("Email");
		lblEmail.setForeground(new Color(0, 0, 0));
		lblEmail.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 20));
		lblEmail.setBounds(27, 313, 62, 31);
		frame.getContentPane().add(lblEmail);

		JLabel lblTelefone = new JLabel("Telefone");
		lblTelefone.setForeground(new Color(0, 0, 0));
		lblTelefone.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 20));
		lblTelefone.setBounds(27, 398, 92, 31);
		frame.getContentPane().add(lblTelefone);

		JLabel lblEndereo = new JLabel("Endereço");
		lblEndereo.setForeground(new Color(0, 0, 0));
		lblEndereo.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 20));
		lblEndereo.setBounds(27, 480, 101, 31);
		frame.getContentPane().add(lblEndereo);

		textFieldNome = new JTextField();
		textFieldNome.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 18));
		textFieldNome.setBounds(27, 172, 397, 31);
		frame.getContentPane().add(textFieldNome);
		textFieldNome.setColumns(10);

		textFieldCPF = new JTextField();
		textFieldCPF.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 18));
		textFieldCPF.setColumns(10);
		textFieldCPF.setBounds(27, 256, 397, 31);
		frame.getContentPane().add(textFieldCPF);

		textFieldEmail = new JTextField();
		textFieldEmail.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 18));
		textFieldEmail.setColumns(10);
		textFieldEmail.setBounds(27, 340, 397, 31);
		frame.getContentPane().add(textFieldEmail);

		textFieldEndereço = new JTextField();
		textFieldEndereço.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 18));
		textFieldEndereço.setColumns(10);
		textFieldEndereço.setBounds(27, 508, 397, 31);
		frame.getContentPane().add(textFieldEndereço);

		textFieldTelefone = new JTextField();
		textFieldTelefone.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 18));
		...
		btnCadastrar.setFont(new Font("Malgun Gothic Semilight", Font.PLAIN, 18));
		...
		scroll.setBounds(27, 564, 397, 174); 
	...
	public boolean salvar() {
		...
		boolean salvo = controller.salvar(textFieldNome.getText(), textFieldCPF.getText(), textFieldEmail.getText(),
				textFieldTelefone.getText(), textFieldEndereço.getText());
		
		if(!salvo) {
			JOptionPane.showMessageDialog(null, "Erro, já existe um cadastro com este CPF!");
			return false;
		}else {
	...
	public void listar() {
		...
		List<Cliente> cliente = controller.listar();
		
		for (Cliente u : cliente) {
			Object[] row = { u.getNome(), u.getCpf(), u.getEndereco(), u.getTelefone(), u.getEmail()};
			modelo.addRow(row);
		}
	...
	public boolean naoVazio() {
		JTextField[] campos = { textFieldNome, textFieldCPF, textFieldEndereço, textFieldTelefone };
		String[] nomesCampos = { "Nome", "CPF", "Endereço", "Telefone" };
	...
	public boolean validar() {
		...
		if (campos[0].getText().matches("\\d+")) {
			JOptionPane.showMessageDialog(null, "Nome inválido, por favor digite apenas letras");
			return false;
		} 
		...
		if ((!campos[2].getText().contains("@") || !campos[2].getText().contains(".com")) && !campos[2].getText().isEmpty()) {
